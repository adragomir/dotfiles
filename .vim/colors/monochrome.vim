...
hi Function ctermfg=15 ctermbg=16 cterm=NONE term=NONE
hi Identifier ctermfg=252 ctermbg=16 cterm=NONE term=NONE
hi Special ctermfg=252 ctermbg=16 cterm=NONE term=NONE
hi MatchParen ctermfg=16 ctermbg=252 cterm=NONE term=NONE
hi rubyConstant ctermfg=252 ctermbg=16 cterm=NONE term=NONE
hi rubySharpBang ctermfg=243 ctermbg=16 cterm=NONE term=NONE
hi rubyStringDelimiter ctermfg=67 ctermbg=16 cterm=NONE term=NONE
hi rubyStringEscape ctermfg=67 ctermbg=16 cterm=NONE term=NONE
hi rubyRegexpEscape ctermfg=67 ctermbg=16 cterm=NONE term=NONE
hi rubyRegexpAnchor ctermfg=67 ctermbg=16 cterm=NONE term=NONE
hi rubyRegexpSpecial ctermfg=67 ctermbg=16 cterm=NONE term=NONE
hi perlSharpBang ctermfg=243 ctermbg=16 cterm=NONE term=NONE
hi perlStringStartEnd ctermfg=67 ctermbg=16 cterm=NONE term=NONE
hi perlStringEscape ctermfg=67 ctermbg=16 cterm=NONE term=NONE
hi perlMatchStartEnd ctermfg=67 ctermbg=16 cterm=NONE term=NONE
