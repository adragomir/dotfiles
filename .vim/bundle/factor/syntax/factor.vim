...
syn keyword factorKeyword with-return restarts return-continuation with-datastack recover rethrow-restarts throw-continue <restart> ifcc original-error cleanup restart? ignore-errors compute-restarts attempt-all-error error-thread continue <continuation> attempt-all-error? condition? <condition> throw-restarts error continue-with thread-error-hook attempt-all continuation rethrow callcc1 error-continuation callcc0 condition restart continuation? return
