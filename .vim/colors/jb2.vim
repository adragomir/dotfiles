...
let s:search = ['#f085a6']
let s:text = ['#d1b897']
let s:comments = ['#e5dd59']
let s:punctuation = ['#d1b897']
let s:type = ['#9ed291']
let s:keywords = ['#ffffff']
let s:variables = ['#d1b897'] "['#c1d1e3']
let s:functions = [s:text[0]]
let s:methods = ['#d1b897']
let s:strings = ['#c4c6c2'] "['#2ec09c']
let s:constants = ['#7fdad1']
let s:macros = ['#8cde94']
...
call s:Hi('Type', s:type, s:none, 'none')
...
call s:Hi('TSType', s:type, s:none, 'none')
call s:Hi('TSTypeBuiltin', s:type, s:none, 'none')
